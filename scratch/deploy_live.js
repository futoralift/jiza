    ...
    stream.on('close', () => {
      ...
      conn.sftp((sftpErr, sftp) => {
        ...
        const filesToUpload = [
          ...
          'src/components/admin/tabs/CustomersTab.jsx',
          'src/components/admin/tabs/ReviewsTab.jsx',
          'src/components/admin/tabs/ProblemsTab.jsx',
          'src/components/admin/tabs/StoreSettingsTab.jsx',
          'src/components/admin/tabs/PremiumFeaturesTab.jsx',
          'server/index.js',
